...
-- minetest 5.4.0 feature
local use_texture_alpha_string_modes = minetest.has_feature("use_texture_alpha_string_modes")
...
minetest.register_node("basic_machines:ball_spawner", {
	...
	param1=1,
	walkable = false,
	alpha = (not use_texture_alpha_string_modes) and 150 or nil,
	use_texture_alpha = use_texture_alpha_string_modes and "blend" or nil,
